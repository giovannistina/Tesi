# Tesi/data_collection/data/chunk_1_old/calcolo_metriche.py
...
# --- CONFIGURAZIONE ---
DIR_PATH = '.' 
OUTPUT_TXT = 'report_statistiche_completo.txt'
IMG_ISTOGRAMMA = 'grafico_istogramma_post.png'
IMG_BOXPLOT = 'grafico_boxplot.png'
IMG_SCATTER = 'grafico_scatter_fama.png'
IMG_TORTA = 'grafico_torta_tipologia.png'
...
def calcola_statistiche_complete():
    print(f"🔍 Cerco file *{SUFFIX} in: '{DIR_PATH}'...")
